...
//!  state 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 /
//!  DRVPWM_TIMER3 DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!  
//!
//! \return 0 disable
//!         1 enable 
...
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 /
//!  DRVPWM_TIMER3 DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!  DRVPWM_CAP0   / DRVPWM_CAP1   / DRVPWM_CAP2   / DRVPWM_CAP3 DRVPWM_CAP4   /
//!  DRVPWM_CAP5   / DRVPWM_CAP6   / DRVPWM_CAP7
//!
//! \param u8Int DRVPWM_CAP_RISING_INT/DRVPWM_CAP_FALLING_INT/
//! DRVPWM_CAP_ALL_INT (The parameter is valid only when capture function)
//!
...
//*****************************************************************************
//
//! \brief This function is used to enable/disable PWM0~7 timer/capture function
//!  
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 /
//!  DRVPWM_TIMER3 DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
...
//!
//!  \param sPt
//!  u32Frequency Frequency (Hz) u8HighPulseRatio High Pulse Ratio u8Mode					//!  / DRVPWM_ONE_SHOT_MODE / DRVPWM_AUTO_RELOAD_MODE
...
//! (The parameter takes effect when u8Frequency = 0) u8PreScale Prescale (1 ~ 255).
//! The PWM input clock = PWM source clock / (u8PreScale + 1) 
//!
//! \return The actual frequency (Hz)  
//! \note If the value is set to 0, the timer will stop. (The parameter takes effect when u8Frequency = 0)
//!  u32Duty Pulse duty (The parameter takes effect when u8Frequency = 0 or
...
//*****************************************************************************
//
//! \brief This function is used to enable/disable PWM0~7 timer/capture I/O
//!  function 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 /
//!  DRVPWM_TIMER3 DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
